  ...
  return (
    <header className="app-header">
      ...
      <div className="header-actions">
        <input className="search-input" type="search" placeholder="Szukaj..." aria-label="Szukaj" />
        ...
        <NavLink to="/settings" className="mode-btn" aria-label="Ustawienia" title="Ustawienia">
